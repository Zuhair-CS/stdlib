...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 2.0, 5.0, 4.0 ) instanceof RandomStream, true, 'returns a stream instance' );
	}
	t.end();
});
...
tape( 'the function returns a factory function which creates stream instances (parameters)', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream() instanceof RandomStream, true, 'returns a stream instance' );
	}
	t.end();
});
