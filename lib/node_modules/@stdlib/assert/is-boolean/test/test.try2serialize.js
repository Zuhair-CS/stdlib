...
tape( 'the function returns `true` if able to serialize', function test( t ) {
	t.strictEqual( serialize( true ), true, 'returns true' );
	t.strictEqual( serialize( new Boolean( true ) ), true, 'returns true' );
	t.strictEqual( serialize( false ), true, 'returns true' );
	t.strictEqual( serialize( new Boolean( false ) ), true, 'returns true' );
	t.end();
});
