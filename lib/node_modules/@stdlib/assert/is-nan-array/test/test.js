...
tape( 'the function tests for an array-like object containing only `NaN` values', function test( t ) {
	...
	t.strictEqual( isNaNArray( arr ), true, 'returns true' );
	...
	arr = [ NaN, 3, NaN ];
	t.strictEqual( isNaNArray( arr ), false, 'returns false' );
...
tape( 'attached to the main export is a method to test for an array-like object containing only primitive `NaN` values', function test( t ) {
	...
	arr = [ NaN, NaN, NaN ];
	t.strictEqual( isNaNArray.primitives( arr ), true, 'returns true' );
	...
	t.strictEqual( isNaNArray.primitives( arr ), false, 'returns false' );
...
tape( 'attached to the main export is a method to test for an array-like object containing only object `NaN` values', function test( t ) {
	...
	arr = [ NaN, NaN, NaN ];
	t.strictEqual( isNaNArray.objects( arr ), false, 'returns false' );
	...
	t.strictEqual( isNaNArray.objects( arr ), true, 'returns true' );
