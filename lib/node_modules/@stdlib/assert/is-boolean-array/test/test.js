...
tape( 'the function tests for an array-like object containing only booleans', function test( t ) {
	...
	t.strictEqual( isBooleanArray( arr ), true, 'returns true' );
	...
	arr = [ true, 'true', null ];
	t.strictEqual( isBooleanArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only boolean primitives', function test( t ) {
	...
	t.strictEqual( isBooleanArray.primitives( arr ), true, 'returns true' );
	...
	t.strictEqual( isBooleanArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only `Boolean` objects', function test( t ) {
	...
	t.strictEqual( isBooleanArray.objects( arr ), true, 'returns true' );
	...
	arr = [ new Boolean( true ), false, false ];
	t.strictEqual( isBooleanArray.objects( arr ), false, 'returns false' );
