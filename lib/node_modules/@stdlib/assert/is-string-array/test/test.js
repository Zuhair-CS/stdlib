...
tape( 'the function tests for an array of `string` values', function test( t ) {
	...
	t.strictEqual( isStringArray( arr ), true, 'returns true' );

	arr = [ 'a', 5, null ];
	t.strictEqual( isStringArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array of `string` primitives', function test( t ) {
	...
	arr = [ 'a', 'b' ];
	t.strictEqual( isStringArray.primitives( arr ), true, 'returns true' );

	arr = [ new String( 'a' ), 'b' ]; // eslint-disable-line no-new-wrappers
	t.strictEqual( isStringArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array of `String` objects', function test( t ) {
	...
	t.strictEqual( isStringArray.objects( arr ), true, 'returns true' );

	arr = [ 'a', 'b' ];
	t.strictEqual( isStringArray.objects( arr ), false, 'returns false' );
