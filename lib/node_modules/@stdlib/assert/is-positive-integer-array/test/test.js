...
tape( 'the function tests for a generic number array having only positive integer values', function test( t ) {
	...
	t.strictEqual( isPositiveIntegerArray( arr ), true, 'returns true' );

	arr = [ 5.0, '3', null ];
	t.strictEqual( isPositiveIntegerArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only positive integer primitives', function test( t ) {
	...
	arr = [ 5.0, 1.0 ];
	t.strictEqual( isPositiveIntegerArray.primitives( arr ), true, 'returns true' );

	arr = [ new Number( 5 ), 1.0, 1.0 ];
	t.strictEqual( isPositiveIntegerArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only number objects with positive integer values', function test( t ) {
	...
	t.strictEqual( isPositiveIntegerArray.objects( arr ), true, 'returns true' );

	arr = [ 5.0, 1.0, 1.0 ];
	t.strictEqual( isPositiveIntegerArray.objects( arr ), false, 'returns false' );
