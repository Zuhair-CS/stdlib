...
tape( 'the function tests for an array-like object containing only negative numbers', function test( t ) {
	...
	t.strictEqual( isNegativeNumberArray( arr ), true, 'returns true' );

	arr = [ -5.0, '-3', null ];
	t.strictEqual( isNegativeNumberArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object having only negative number primitives', function test( t ) {
	...
	arr = [ -5.0, -2.0 ];
	t.strictEqual( isNegativeNumberArray.primitives( arr ), true, 'returns true' );

	arr = [ new Number( -5 ), -1.0, -1.0 ];
	t.strictEqual( isNegativeNumberArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object having only negative number objects', function test( t ) {
	...
	t.strictEqual( isNegativeNumberArray.objects( arr ), true, 'returns true' );

	arr = [ -5.0, -1.0 ];
	t.strictEqual( isNegativeNumberArray.objects( arr ), false, 'returns false' );
