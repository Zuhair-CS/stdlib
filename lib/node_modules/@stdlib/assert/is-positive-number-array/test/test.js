...
tape( 'the function tests for an array-like object containing only positive numbers', function test( t ) {
	...
	t.strictEqual( isPositiveNumberArray( arr ), true, 'returns true' );

	arr = [ 5.0, '3', null ];
	t.strictEqual( isPositiveNumberArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object having only positive number primitives', function test( t ) {
	...
	arr = [ 5.0, 2.0 ];
	t.strictEqual( isPositiveNumberArray.primitives( arr ), true, 'returns true' );

	arr = [ new Number( 5 ), 1.0, 1.0 ];
	t.strictEqual( isPositiveNumberArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object having only positive number objects', function test( t ) {
	...
	t.strictEqual( isPositiveNumberArray.objects( arr ), true, 'returns true' );

	arr = [ 5.0, 1.0 ];
	t.strictEqual( isPositiveNumberArray.objects( arr ), false, 'returns false' );
