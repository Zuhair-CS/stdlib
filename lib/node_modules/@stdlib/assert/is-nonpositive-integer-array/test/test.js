...
tape( 'the function tests for an array-like object containing only nonpositive integer values', function test( t ) {
	...
	t.strictEqual( isNonPositiveIntegerArray( arr ), true, 'returns true' );
	...
	arr = [ -5.0, '3', null ];
	t.strictEqual( isNonPositiveIntegerArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only nonpositive primitive integers', function test( t ) {
	...
	arr = [ -5.0, -1.0, 0 ];
	t.strictEqual( isNonPositiveIntegerArray.primitives( arr ), true, 'returns true' );
	...
	t.strictEqual( isNonPositiveIntegerArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only Number objects having nonpositive integer values', function test( t ) {
	...
	t.strictEqual( isNonPositiveIntegerArray.objects( arr ), true, 'returns true' );

	arr = [ -5, -3, 0 ];
	t.strictEqual( isNonPositiveIntegerArray.objects( arr ), false, 'returns false' );
