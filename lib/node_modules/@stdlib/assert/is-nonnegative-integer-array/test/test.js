...
tape( 'the function tests for an array-like object containing only nonnegative integer values', function test( t ) {
	...
	t.strictEqual( isNonNegativeIntegerArray( arr ), true, 'returns true' );

	arr = [ 5.0, '3', null ];
	t.strictEqual( isNonNegativeIntegerArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only primitive nonnegative integers', function test( t ) {
	...
	arr = [ 5.0, 0.0 ];
	t.strictEqual( isNonNegativeIntegerArray.primitives( arr ), true, 'returns true' );

	arr = [ new Number( 5 ), 1.0, 1.0 ];
	t.strictEqual( isNonNegativeIntegerArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only nonnegative object integers', function test( t ) {
	...
	t.strictEqual( isNonNegativeIntegerArray.objects( arr ), true, 'returns true' );

	arr = [ 5.0, 0.0 ];
	t.strictEqual( isNonNegativeIntegerArray.objects( arr ), false, 'returns false' );
