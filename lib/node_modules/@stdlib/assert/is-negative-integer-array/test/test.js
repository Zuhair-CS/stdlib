...
tape( 'the function tests for an array-like object containing only negative integer values', function test( t ) {
	...
	t.strictEqual( isNegativeIntegerArray( arr ), true, 'returns true' );
	...
	arr = [ -5.0, '3', null ];
	t.strictEqual( isNegativeIntegerArray( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only negative primitive integers', function test( t ) {
	...
	arr = [ -5.0, -1.0 ];
	t.strictEqual( isNegativeIntegerArray.primitives( arr ), true, 'returns true' );
	...
	t.strictEqual( isNegativeIntegerArray.primitives( arr ), false, 'returns false' );
...
tape( 'the function provides a method to test for an array-like object containing only Number objects having negative integer values', function test( t ) {
	...
	t.strictEqual( isNegativeIntegerArray.objects( arr ), true, 'returns true' );

	arr = [ -5, -3 ];
	t.strictEqual( isNegativeIntegerArray.objects( arr ), false, 'returns false' );
