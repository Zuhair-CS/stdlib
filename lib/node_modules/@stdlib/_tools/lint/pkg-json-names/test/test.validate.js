...
tape( 'the function returns null if all options are valid', function test( t ) {
	...
	t.equal( opts.dir, './', 'sets dir option' );
	t.equal( opts.pattern, '**/*.json', 'sets pattern option' );
...
tape( 'the function returns null when provided a valid `ignore` option (string)', function test( t ) {
	...
	t.equal( err, null, 'returns null' );
	t.equal( opts.ignore, '**/*.txt', 'sets ignore option' );
	t.end();
});
...
tape( 'the function returns null when provided a valid `ignore` option (array)', function test( t ) {
	...
	t.equal( err, null, 'returns null' );
	t.deepEqual( opts.ignore, [ '**/*.txt', '**/*.md' ], 'sets ignore option' );
	t.end();
});
