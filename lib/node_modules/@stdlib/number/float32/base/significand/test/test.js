...
tape( 'the function returns a number', function test( t ) {
	t.strictEqual( typeof significandf( toFloat32( 3.14e30 ) ), 'number', 'returns a number' );
	t.end();
});
...
tape( 'the function returns the significand for `+-0`', function test( t ) {
	t.strictEqual( significandf( 0.0 ), 0, 'returns 0' );
	t.strictEqual( significandf( -0.0 ), 0, 'returns 0' );
	t.end();
});

tape( 'the function returns the significand for `+infinity`', function test( t ) {
	t.strictEqual( significandf( PINF ), 0, 'returns 0' );
	t.end();
});

tape( 'the function returns the significand for `-infinity`', function test( t ) {
	t.strictEqual( significandf( NINF ), 0, 'returns 0' );
	t.end();
});
