...
tape( 'the function returns a factory function', function test( t ) {
	...
	t.strictEqual( typeof createStream, 'function', 'returns a function' );
	t.end();
});
...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( noop ) instanceof TransformStream, true, 'returns a stream instance' );
	}
	// Provide both transform and flush functions...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( noop, noop ) instanceof TransformStream, true, 'returns a stream instance' );
	}
