...
tape( 'the function returns a factory function which creates stream instances', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream( 'beep' ) instanceof ConstantStream, true, 'returns a stream instance' );
	}
	t.end();
});
...
tape( 'the function returns a factory function which creates stream instances (parameters)', function test( t ) {
	...
	for ( i = 0; i < 10; i++ ) {
		t.strictEqual( createStream() instanceof ConstantStream, true, 'returns a stream instance' );
	}
	t.end();
});
