...
tape( 'the function returns an accumulator function', function test( t ) {
	t.strictEqual( typeof incrmeanvar(), 'function', 'returns a function' );
	t.end();
});

tape( 'the function returns an accumulator function (output)', function test( t ) {
	t.strictEqual( typeof incrmeanvar( [ 0.0, 0.0 ] ), 'function', 'returns a function' );
	t.end();
});
...
tape( 'the sample variance is `0` until at least 2 datums have been provided', function test( t ) {
	...
	mv = acc();
	t.strictEqual( mv, null, 'returns null' );
