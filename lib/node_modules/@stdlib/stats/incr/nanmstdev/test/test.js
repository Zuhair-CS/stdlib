...
tape( 'the function returns an accumulator function', function test( t ) {
	t.strictEqual( typeof incrnanmstdev( 3 ), 'function', 'returns a function' );
	t.end();
});

tape( 'the function returns an accumulator function (known mean)', function test( t ) {
	t.strictEqual( typeof incrnanmstdev( 3, 3.0 ), 'function', 'returns a function' );
	t.end();
});
