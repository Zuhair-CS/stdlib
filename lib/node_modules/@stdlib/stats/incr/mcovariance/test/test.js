...
tape( 'the function returns an accumulator function', function test( t ) {
	t.strictEqual( typeof incrmcovariance( 3 ), 'function', 'returns a function' );
	t.end();
});

tape( 'the function returns an accumulator function (known means)', function test( t ) {
	t.strictEqual( typeof incrmcovariance( 3, 3.0, 3.14 ), 'function', 'returns a function' );
	t.end();
});
...
tape( 'if the window size is `1` and the means are unknown, the accumulator function always returns `0`', function test( t ) {
	...
	for ( i = 0; i < 100; i++ ) {
		...
		t.strictEqual( cov, 0.0, 'returns 0' );
	}
	t.end();
});
