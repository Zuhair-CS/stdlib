...
interface Routine {
	...
	* // returns true
	*/
	( N: number, alternative: Alternative, alpha: number, mu: number, sigma: number, x: Float32Array, strideX: number, out: BaseResults ): Results;
	...
	* // returns true
	*/
	ndarray( N: number, alternative: Alternative, alpha: number, mu: number, sigma: number, x: Float32Array, strideX: number, offsetX: number, out: BaseResults ): Results;
}
