...
/**
* Tests if two arguments are both Float64Arrays and are almost equal within a specified number of units in the last place (ULPs).
*
* @private
* @param {*} v1 - first value
* @param {*} v2 - second value
* @param {NonNegativeInteger} maxULPs - maximum number of units in the last place (ULPs)
...
* // returns false
*/
function isAlmostEqualFloat64Array( v1, v2, maxULPs ) {
	return ( isFloat64Array( v1 ) && isFloat64Array( v2 ) && isAlmostEqual( v1, v2, maxULPs ) );
}
...
tape( 'the function computes a covariance matrix (row-major)', function test( t ) {
	...
	t.strictEqual( isAlmostEqualFloat64Array( out, expected, 1 ), true, 'returns expected value' );
	t.end();
});
